...
//==================================================
// EP64: STEP#1 (IMPORT MODEL)
//==================================================
import '../models/Ep641MenuModel.dart';

//==================================================
// MAIN CLASS
//==================================================
class Ep641Page extends StatefulWidget {
  @override
  _Ep641PageState createState() => _Ep641PageState();
}

//==================================================
// STATE CLASS
//==================================================
class _Ep641PageState extends State<Ep641Page> {
//==================================================
...
//==================================================
// EP64: STEP#2 (DECLARE MODEL VARIABLE)
//==================================================
        ...
        title: 
          Column(         
            ...
            children: <Widget>[
              Row(
                children: <Widget>[
                  Text('EP64-1: Add Order by Model',style: TextStyle(fontSize: 16),),
//==================================================
...
//==================================================
// EP64: STEP#3 (GET DATA FROM DB- FIRESTORE)
//==================================================      
        stream: _menuModel.getMenu(categoryValue: foodCategory) ,      
...
//==================================================
// EP64: STEP#4 (FILL DATA TO MODEL "FACTORY METHOD")
//================================================== 
                _menuModel = MenuModel.fromFireStore(snapshot.data.documents[index]) ;                  
//==================================================
// RETURN CONTAINER 
//==================================================                
              return 
...
//==================================================     
//==================================================
// EP64: STEP#5.1 (FILL DATA FROM MODEL)
//==================================================
...
//==================================================
// EP64: STEP#5.2 (FILL DATA FROM MODEL)
//==================================================
                  title: _menuModel.menuNameEng,
                  description: _menuModel.menuDescriptionEng,    
                  price: _menuModel.price,
                  imageStr: _menuModel.imageUrl,                                    
