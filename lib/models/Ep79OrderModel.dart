...
//========================================================
  factory Ep79OrderModel.fromFireStore(DocumentSnapshot doc){
    Map data = doc.data;
    return Ep79OrderModel(
...
// ORDER SERVICE CLASS
//==================================================
class EP79OrderService{

//==================================================
// fUNCTION OPEN TABLE
//==================================================  
  static void openTableEP79({ int noOfGuest,String customerName, String customerMobileNo, String tableNo,})
  {
//==================================================
// DECLARE VARIABLE
//==================================================    
...
//==================================================
    Ep79OrderModel _orderModel = Ep79OrderModel(
        customerInfo: _customerInfo,
        listOrderItemInfo: [],
        tableNo: tableNo,
        orderNo: _orderNo,
...
//==================================================
// SAVE DATA TO TM_EP75_TABLE DATABASE ** CHANGE EP79
//==================================================
  Firestore.instance.collection('TM_EP79_TABLES').document(tableNo).setData(_tableModel.toFireStore()).then((value) {
    print('Save TM_EP79_TABLES Completed with ${_tableModel.toFireStore()}' );
  }).catchError((error){
    print('Error to save table $error');
  });

//==================================================
// SAVE DATA TO T5_EP75_ORDER DATABASE ** CHANGE EP79
//================================================== 
  Firestore.instance.collection('TT_EP79_ORDERS').document(_orderNo).setData(_orderModel.toFireStore()).then((value) {
...
//==================================================
// FUNCTION ADD ORDER ITEM, EP79
//================================================== 
  static void addOrderItemEP79({
//==================================================
// DECLARE PARAMETERS
//==================================================       
      String orderNo,
...
//==================================================     
    Firestore.instance.collection('TT_EP79_ORDERS').document(orderNo).collection('listOrderItemInfo').add(orderItemInfo.toFireStore()).then((value) {
