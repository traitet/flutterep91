...
class Ep511APage extends StatefulWidget {
  @override
  _Ep511APageState createState() => _Ep511APageState();
}

class _Ep511APageState extends State<Ep511APage> {
//==================================================
// DECLARE VARIABLE
//==================================================
String foodCategory='';   
...
//==================================================           
        title: 
          Column(         
            ...
            children: <Widget>[
              Text('EP51-1A: Logic - Edit Menu (Search)',style: TextStyle(fontSize: 16),),
...
//==================================================                   
                    onTap: () {
                      Navigator.push(context,MaterialPageRoute(builder: (context) => Ep511BPage(menuId: snapshot.data.documents[index].documentID)),);
                    },
