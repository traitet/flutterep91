...
// MAIN CLASS
//==================================================================   
class Ep471BPage extends StatefulWidget {
  @override
  _Ep471BPageState createState() => _Ep471BPageState();
}

//==================================================================
// STATE CLASS
//==================================================================   
class _Ep471BPageState extends State<Ep471BPage> {
//==================================================================
// DECLARE VARIABLE
//==================================================================
//======================================================
...
//======================================================   
 ...
 void initState(){
   super.initState();
//======================================================
// 1) GET DATA FROM GLOBAL VAIRABLE (SINGLETON CLASS)
//======================================================    
   GlobalAppData globalAppData = GlobalAppData();
//======================================================
// 2) GET DATA FROM DATABASE (FIREBASE)
//======================================================  
print(globalAppData.email);  
   Firestore.instance.collection('TM_USERS').document(globalAppData.email).get().then((value) {
     emailController.text = value.data['email'];
     nameController.text = value.data['name'];
     addressController.text = value.data['adress'];
...
//======================================================  
      key: scaffoldKey,   
      appBar: AppBar(title: Text('Ep47-1: Logic: UI Edit User Profile'),),
