...
//========================================================
  factory Ep77OrderModel.fromFireStore(DocumentSnapshot doc){
    Map data = doc.data;
    return Ep77OrderModel(
...
// ORDER SERVICE CLASS
//==================================================
class EP77OrderService{

//==================================================
// fUNCTION OPEN TABLE
//==================================================  
  static void openTableEP77({ int noOfGuest,String customerName, String customerMobileNo, String tableNo,})
  {
//==================================================
// DECLARE VARIABLE
//==================================================    
...
//==================================================
    Ep77OrderModel _orderModel = Ep77OrderModel(
        customerInfo: _customerInfo,
        listOrderItemInfo: [],
        tableNo: tableNo,
        orderNo: _orderNo,
...
//==================================================
// SAVE DATA TO TM_EP75_TABLE DATABASE ** CHANGE EP77
//==================================================
  Firestore.instance.collection('TM_EP77_TABLES').document(tableNo).setData(_tableModel.toFireStore()).then((value) {
...
//==================================================
// SAVE DATA TO T5_EP75_ORDER DATABASE ** CHANGE EP77
//================================================== 
  Firestore.instance.collection('TT_EP77_ORDERS').document(_orderNo).setData(_orderModel.toFireStore()).then((value) {
...
//==================================================
// FUNCTION ADD ORDER ITEM, EP77
//================================================== 
  static void addOrderItemEP77({
//==================================================
// DECLARE PARAMETERS
//==================================================       
      String orderNo,
...
//==================================================     
    Firestore.instance.collection('TT_EP77_ORDERS').document(orderNo).collection('listOrderItemInfo').add(orderItemInfo.toFireStore()).then((value) {
