...
class Ep531BPage extends StatefulWidget {
//======================================================
...
const Ep531BPage(
  ...
  @override
  _Ep531BPageState createState() => _Ep531BPageState();
}

class _Ep531BPageState extends State<Ep531BPage> {
//============================================================================================================
// DECLARE VARIABLE: STEP#1 (EP53)
//============================================================================================================  
  File _image;
  String _imageUrl;
...
//======================================================  
      key: scaffoldKey,         
      appBar: AppBar(title: Text('EP53-1B: Logic - Upload Image/Edit Menu (Menu Detail)'),
//===================================================
// ACTION
//===================================================      
        actions: <Widget>[
...
//=========================================================================================================================================================
//  EP53: ADD IMAGE PICKERSTEP#2  ( can select gallery or camera)
//=========================================================================================================================================================
...
// BUTTON
//===================================================
          }, child: Text('Click to upload photo',style: TextStyle(color: Colors.white),), color: Colors.blue,),   
          // Image(height: 150,width: 150,image: NetworkImage(imageUrlController.text??''),)  ,
//=========================================================================================================================================================
//  EP53: SHOW IMAGE AFTER USE PICKER PICKERSTEP#3
//=========================================================================================================================================================          
          _image!=null ? Image.asset(_image.path,height: 300,):Image.network(imageUrlController.text??'',height: 300,),
//===================================================
// TEXT FORM FIELD
//===================================================                       
...
//===================================================  
  fnSaveMenuToDb() async {
//=========================================================================================================================================================
// UPLOAD IMAGE TO CLOUD: EP53:STEP#5
//=========================================================================================================================================================  
    await fnUploadFile();
    print(_imageUrl);
...
//=========================================================================================================================================================
//  EP53: FUNCTION UPLOAD FILE STEP#4
//=========================================================================================================================================================     
Future fnUploadFile() async {
  StorageReference storageRerference = FirebaseStorage.instance.ref().child('foodmenu').child(myPath.basename(_image.path));
  StorageUploadTask uploadTask = storageRerference.putFile(_image);
