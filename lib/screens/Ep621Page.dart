...
//============================================= 
class Ep621Page extends StatefulWidget {
//=============================================
// PROPERTY
//============================================= 
...
//=============================================  
  @override
  _Ep621PageState createState() => _Ep621PageState();
}

//=============================================
// STATE CLASS
//============================================= 
class _Ep621PageState extends State<Ep621Page> {
//=============================================
...
//=============================================       
      appBar: AppBar(title: 
        Column(
          ...
          children: <Widget>[
            Text('EP62-1: Coding - Order Item (Edit qty)'),
...
//=============================================                  
                onPressedEdit: (){
                  Navigator.push(context,MaterialPageRoute(builder: (context) => Ep622Page(documentId: snapshot.data.documents[index].documentID,)),);
                },
//=============================================
