...
//========================================================
  factory Ep75OrderModel.fromFireStore(DocumentSnapshot doc){
    Map data = doc.data;
    return Ep75OrderModel(
...
//==================================================
    Ep75OrderModel _orderModel = Ep75OrderModel(
        customerInfo: _customerInfo,
        listOrderItemInfo: [],
        tableNo: tableNo,
        orderNo: _orderNo,
...
//==================================================
  Firestore.instance.collection('TM_EP67_TABLES').document(tableNo).setData(_tableModel.toFireStore()).then((value) {
...
//================================================== 
  Firestore.instance.collection('TT_EP67_ORDERS').document(_orderNo).setData(_orderModel.toFireStore()).then((value) {
