...
class Ep561Page extends StatefulWidget {
  @override
  _Ep561PageState createState() => _Ep561PageState();
}

class _Ep561PageState extends State<Ep561Page> {
//==================================================
        ...
        title: 
          Column(         
            ...
            children: <Widget>[
              Row(
                children: <Widget>[
                  Text('EP56-1: Logic - Count order item ',style: TextStyle(fontSize: 16),),
//==================================================
// EP56 STEP#2: STEAMBUILDER
//================================================== 
                  StreamBuilder(
                    stream: Firestore.instance.collection('TT_ORDERS').where('orderNo', isEqualTo: 'ORD006').snapshots(),
